$(function(){
    ...
    $('#calendar').fullCalendar({
        ...
        events: './requests/calander/getEmploiEvents.php',
        ...
        dayClick: function(date, event, view) {
            ...
            modal({
                ...
                title: 'Ajouter Emploi (' + date.format() + ')' // Modal title
            });
        },
        // Event Mouseover
    ...
    $('.modal').on('click', '#add-event',  function(e){
        if(validator(['title', 'description'])) {
            $.post('./requests/calander/addEmploiEvent.php', {
                title: $('#title').val(),
    ...
    $('.modal').on('click', '#update-event',  function(e){
        if(validator(['title', 'description'])) {
            $.post('./requests/calander/updateEmploiEvent.php', {
                id: currentEvent._id,
                title: $('#title').val(),
                description: $('#description').val(),
                color: $('#color').val(),
    ...
    $('.modal').on('click', '#delete-event',  function(e){
        $.get('./requests/calander/deleteEmploiEvent.php?id=' + currentEvent._id, function(result){
            $('.modal').modal('hide');
            $('#calendar').fullCalendar("refetchEvents");
        });
    });
