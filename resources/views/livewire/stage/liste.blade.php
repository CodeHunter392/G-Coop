...
<div class="row p-4 pt-5">
    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body table-responsive p-0 table-striped" style="height: max;widht: max;">
                <table class="table table-head-fixed ">
                    <thead>
                        <tr>
                            ...
                            <th style="width:20%;">Etudiant</th>
                                ...
                                <th style="width:20%;">Binome</th>
                               
                            
                            <th style="width:15%;">Lieu</th>
                            <th style="width:15%;" class="text-center">Date de soutenance</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td></td>
                            <td>{{ $stage->sujet }}</td>
                            <td>{{ $stage->nometudiant($stage->ins_id)}}</td>
