...
<canvas id="programmeBarChart" width="300" height="300"></canvas>
<script>
    // Récupération du contexte 2D du canvas
    var ctx = document.getElementById('programmeBarChart').getContext('2d');

    // Création du Bar Chart
    var programmeBarChart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                ...
                data: @json($testData3), // Nombre de familles touchées par programme
                backgroundColor: '#284a71' // Couleurs des barres
                // borderColor: [
                //     'rgba(255, 99, 132, 1)',
                //     'rgba(54, 162, 235, 1)',
                //     'rgba(255, 206, 86, 1)',
